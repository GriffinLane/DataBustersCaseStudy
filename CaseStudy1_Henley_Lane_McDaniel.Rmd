...
The results of the data MABCo provided show the top five breweries offering specialty craft beers are in Texas (255), Colorado (253), Indiana (199), Oregon (188), and New York (168). The data also presents the median alcohol by volume (ABV) for each state. The states with the highest median ABV are Georgia, Florida, and Idaho with each recording a median of 0.092. Although these states recorded the highest median values, Colorado's Lee Hill Series Vol. 5 - Belgian Style Quadrupel Ale with an ABV of 0.128 ABV was the highest overall.  When examining all beer offerings, the average ABV was found to be 0.05977. Data was provided for each state regarding the bitterness of the beers measured in international bitterness units, IBU. DBI determined that the states with the highest median bitter beers as measured in IBU's are NY, OH, NC, OR, PA, NM, MT, SC, and NJ, with each state returning a median IBU score of 135 IBU.  When measuring IBU overall maximum's we found that the individual state returning the highest IBU of 138 was Oregon with their Bitter Bitch Imperial IPA. Unlike Colorado with the highest ABV, Oregon is included in the highest median population examined.  A graphical representation outlining the positive linear relationship between the ABV and the IBU of each of the beers is displayed. As the ABV increased, so did the IBU. 
